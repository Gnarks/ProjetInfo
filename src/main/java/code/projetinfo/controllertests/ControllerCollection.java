...
public class ControllerCollection {
    ...
    protected void PlagueDocPressed(){
        setGhostImage(new Image("code/projetinfo/Sprite_Ghosts/Sprite_GhostS3x2_Rotation0.png"),200,300,650,180);
    ...
    protected void ScooboodooPressed(){
        setGhostImage(new Image("code/projetinfo/Sprite_Ghosts/Sprite_GhostJ2x2_Rotation0.png"),250,250,675,180);
    ...
    protected void NapstaPressed(){
        setGhostImage(new Image("code/projetinfo/Sprite_Ghosts/Sprite_Ghost1x3_Rotation0.png"),300,100,750,150);
    ...
    protected void BigBobPressed(){
        setGhostImage(new Image("code/projetinfo/Sprite_Ghosts/Sprite_Ghost2x3_Rotation0.png"),240,160,720,180);
    ...
    protected void BobPressed() {
        setGhostImage(new Image("code/projetinfo/Sprite_Ghosts/Sprite_Ghost1x2_Rotation0.png"),250,125,732.5,180);
        setGhostName("Bob",780);
        GhostDescription.setText("He is more scared of you than you of him.");
    }
    @FXML
    protected void AmogousPressed(){
        setGhostImage(new Image("code/projetinfo/Sprite_Ghosts/Sprite_GhostL2x2_Rotation0.png"),250,250,675,180);
    ...
    protected void BooBellePressed(){
        setGhostImage(new Image("code/projetinfo/Sprite_Ghosts/Sprite_GhostBigL3x3_Rotation0.png"),250,250,675,180);
    ...
    protected void ToowelsPressed(){
        setGhostImage(new Image("code/projetinfo/Sprite_Ghosts/Sprite_GhostL2x4_Rotation0.png"),250,125,732.5,180);
    ...
    protected void LilDeathPressed(){
        setGhostImage(new Image("code/projetinfo/Sprite_Ghosts/Sprite_GhostJ2x3_Rotation0.png"),240,160,720,180);
    ...
    protected void VicKingPressed(){
        setGhostImage(new Image("code/projetinfo/Sprite_Ghosts/Sprite_Ghost3x3_Rotation0.png"),250,250,675,180);
    ...
    protected void RedkyPressed(){
        setGhostImage(new Image("code/projetinfo/Sprite_Ghosts/Sprite_Ghost2x2_Rotation0.png"),250,250,675,180);
    ...
    protected void BabyPressed(){
        setGhostImage(new Image("code/projetinfo/Sprite_Ghosts/Sprite_Ghost1x1_Rotation0.png"),250,250,675,180);
        setGhostName("Baby",775);
        GhostDescription.setText("He is little, he is a baby. That's it");
    }
    @FXML
    protected void BlobyPressed(){
        setGhostImage(new Image("code/projetinfo/Sprite_Ghosts/Sprite_Ghost2x2TopLeft_Rotation0.png"),240,160,720,180);
        setGhostName("Bloby",765);
        GhostDescription.setText("Too cute to scare someone.");
    }
    @FXML
    protected void NessyPressed(){
        setGhostImage(new Image("code/projetinfo/Sprite_Ghosts/Sprite_Ghost2x2TopRight_Rotation0.png"),240,160,720,180);
    ...
    protected void KingPressed(){
        setGhostImage(new Image("code/projetinfo/Sprite_Ghosts/Sprite_Ghost2x4_Rotation0.png"),250,125,732.5,180);
    ...
    protected void GeoffreyPressed(){
        setGhostImage(new Image("code/projetinfo/Sprite_Ghosts/Sprite_Ghost2x6_Rotation0.png"),300,100,750,150);
    ...
    protected void BigBrooPressed(){
        setGhostImage(new Image("code/projetinfo/Sprite_Ghosts/Sprite_GhostC3x2_Rotation0.png"),200,300,650,180);
    ...
    protected void PhantomPressed(){
        setGhostImage(new Image("code/projetinfo/Sprite_Ghosts/Sprite_GhostBigJ3x3_Rotation0.png"),250,250,675,180);
    ...
    protected void WolfyPressed(){
        setGhostImage(new Image("code/projetinfo/Sprite_Ghosts/Sprite_Ghost3x32TopRight_Rotation0.png"),250,187.5,706.25,180);
